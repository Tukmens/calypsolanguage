...
//----------------ACADEMY SKIL NAMES----------------
	1101 => 'Weaponry',
	1102 => 'Weapons Class A',
	1103 => 'Double attack',
	1104 => 'Standardisation (Fleet)',
	1105 => 'Engine limitation',
	1106 => 'Computerization',
	1107 => 'Engine economication',
	1108 => 'Accurate shots',
	1109 => 'Chain reaction',
	1110 => 'Strengthening explosion',
	1111 => 'Focusing',
	1112 => 'Relief ships',
	
	1201 => 'Production speed',
	1202 => 'Energetics',
	1203 => 'Magistracy',
	1204 => 'Cosmo depot',
	1205 => 'Academy of Sciences',
	1206 => 'Expanding Empire',
	1207 => 'Packing of cargo',
	1208 => 'Global defense',
	1209 => 'Thermonuclear reaction',        
	1210 => 'Solar panels',
	1211 => 'Empire',
	
	1301 => 'Defensive strategy',
	1302 => 'Defence class A',
	1303 => 'Double shields',    
	1304 => 'Mechanics',
	1305 => 'Shield complex',
	1306 => 'Defense complex',
	1307 => 'Seal Shield Dome',
	1308 => 'Heavy Armour',
	1309 => 'Maximum defense',
	1310 => 'Standardisation (defense)',
	1311 => 'Sealing double shields',
	);
...
69 => 'After years of study of antimatter, scientists have finally invented a way to create dark matter. It consists in breaking up antimatter collider. But the work of the collider prevent the planet\'s atmosphere, so it was decided to build it on the moon, where the atmosphere does not exist.',
51 => 'With each level increases the probability of finding Stardust.
	<br><br>
	...
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> With each level increases the chance of finding the Star dust 1%.</font>',
	52 => 'The sensor module displays the movement of all the fleets of enemy alliances.
	<br><br>
	<font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> With each level of the scanning range is increased by 3 system.</font>',
	
	53 => 'Research Center, with each level of technology reduce  research time by 3% and reduced 1% the required amount of fuel for ships flying.',
	
	71 => 'Light conveyor is built for continuous construction of a light fleet and defense, taking into account technology and sequence assembly of 10 units ships in the second.Produced: Small vehicles, large transport, Light Fighter, Heavy Fighter, Recycler, rocket launchers, laser Light, Heavy Laser.
	<br><br>
	<font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font><br>
    <font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Removes the chapel at 1 unit per second, during the construction of the fleet and defense. </font><br>
    <font color="#BC8F8F"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Accelerate the construction of  planet where conveyor is made.</font>',
	72 => 'Average conveyor considerably improves the performance of the average fleet and defense up to 5 units per second by replacing routine, monotonous work, ultra-precise machines. Produced: Cruiser, Battleship, Bomber, Shredder, Battlecruiser, Superior transportation Mega processor, Gauss Cannon, ion cannon, plasma guns, Hydrogen cannon Cannon Dora.
	<br><br>
	<font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Removes the chapel at 1 unit per second, during the construction of the fleet and defense.</font><br>
	<font color="#BC8F8F"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Accelerate the construction of  planet where conveyor is made.</font>',
	73 => 'Heavy conveyor was built after the introduction of a software redirection process on the input of another process, which allowed to build 1 unit heavy naval and defense in a second longer. Produced: Death Star, Supernova, picture, Battleship class ONill, Flying death, Galleon, destroyer, frigate, black wanderer the graviton weapon, leptons Cannon, Proton cannon Canyon, photon cannon, particle emitter. 
	<br><br>
	<font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Removes the chapel at 1 unit per second, during the construction of the fleet and defense. </font><br>
	<font color="#BC8F8F"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>	Accelerate the construction of  planet where conveyor is made.</font> ',
...
231 => 'Spaceship «LEXX» — «the most powerful weapon of destruction in the two universes». This is a huge living and intelligent spaceship, which is essentially an insect: it is very similar to a dragonfly both externally and
   Physiology (he is afraid of cobwebs and spiders, if they have the space dimensions). It is designed to destroy planets with one powerful shot, then to swallow biological balances and use them as fuel.
   "Lex" was originally grown to serve His Divine Shadow, but later served for the destruction of which was established by his "Divine Order". 
  <br><br>
  <font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font><br>
  <font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> It used to enemy attacks.</font><br>
  <font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> With the destruction of 30-50% of resources expended fall in fragments.</font><br>
  <font color="#B22222"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Heavy conveyor.</font><br>
   <font color="fold"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>Build only on the moons</font><br>',
...
701 => array(0 => 'Attack', 1=> 'Armor'),

  702 => array(0 => 'for shields'),

  703 => array(0 => 'construction time'),

  704 => array(0 => 'the extraction of  materials'),

  705 => array(0 => 'to energy production'),

  706 => array(0 => 'time research'),

  707 => array(0 => 'ship fyling time'),

//----------------SKILS----------------
	1101 => "<span style='color:#0C0;'>+%d%%</span> Attack",
	1102 => "<span style='color:#0C0;'>+%d%%</span> Attack<br /><span style='color:#F90;'>-%d%%</span> Shields and armor",
	1103 => "<span style='color:#0C0;'>+%d%%</span> cumulative probability of shot shell",
	1104 => "<span style='color:#0C0;'>-%d%%</span> fleet cost",
	1105 => "<span style='color:#0C0;'>+%d%%</span> Fleet speed",
	1106 => "<span style='color:#0C0;'>+%d%%</span> slots to the fleet",
	1107 => "<span style='color:#0C0;'>-%d%%. </span> deuterium consumption",
	1108 => "<span style='color:#0C0;'>+%d%%</span> to the maximum number of destroys per round",
	1109 => "<span style='color:#0C0;'>+%d%%</span> the possibility of causing a chain reaction",
	1110 => "<span style='color:#0C0;'>+%d%% </span> the destruction of additional units",
	1111 => "<span style='color:#0C0;'>+%d%%</span> ship focus",
    1112 => "<span style='color:#0C0;'>-%d%%</span> Fuel consumption<br /><span style='color:#F90;'>-%d%%</span> Armour",
	
	1201 => "<span style='color:#0C0;'>+%d%%</span> extraction of mines",
	1202 => "<span style='color:#0C0;'>+%d%%</span> to energy production",
	1203 => "<span style='color:#0C0;'>-%d%%</span> studying time",
	1204 => "<span style='color:#0C0;'>+%d%%</span> more space in ress storage",
	1205 => "<span style='color:#0C0;'>+%d%. </span> to Intergalactic Research Network",
	1206 => "<span style='color:#0C0;'>+%d%. </span> the maximum number of planets in the Empire",
	1207 => "<span style='color:#0C0;'>+%d%%</span> more fleet space",
	1208 => "<span style='color:#0C0;'>+%d%. </span>  maximum number of shield domes",
	1209 => "<span style='color:#0C0;'>+%d%% </span> to power generation fusion reactor",
	1210 => "<span style='color:#0C0;'>+%d%% </span> to develop solar power satellites",
	1211 => "<span style='color:#0C0;'>+%d%% </span> the attack, armor, shields and ship speed.",

	1301 => "<span style='color:#0C0;'>+%d%%</span> to shields and armorе",
	1302 => "<span style='color:#0C0;'>+%d%%</span> Shields and Armors<br /><span style='color:#F90;'>-%d%%</span> Attack",
	1303 => "<span style='color:#0C0;'>+%d%%</span> the probability of double shields",
	1304 => "<span style='color:#0C0;'>+%d%%</span> Defense recover",
	1305 => "<span style='color:#0C0;'>+%d%%</span> shields the defense",
	1306 => "<span style='color:#0C0;'>+%d%%</span> armor in defense",
	1307 => "<span style='color:#0C0;'>+%d%%</span> the probability of the missile destruction",
	1308 => "<span style='color:#0C0;'>-%d%%</span> destruction of rapid fire",
	1309 => "<span style='color:#0C0;'>+%d%. </span> the maximum number of orbital bases",	
	1310 => "<span style='color:#0C0;'>-%d%% </span> to the defense value",	
	1311 => "<span style='color:#0C0;'>+%d%% </span> to density double shield",	
);
...
69 => 'After years of study of antimatter, scientists have finally invented a way to create dark matter. It consists in breaking up antimatter collider. But the work of the collider prevent the planet\'s atmosphere, so it was decided to build it on the moon, where the atmosphere does not exist.<br><br>
	<font color="#3399CC"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span>	Helpful information:</font>
	<br>
...
109 => 'Weapons technology is a key research crucial to your survival against enemy empires. Weapons Technology explores the weapons systems on ships to make enemy defenses less effective.<br><br>
	...
	<br><span onclick="$(\'#id_11\').slideToggle();return false" style="cursor:pointer;"><img alt="" src="/styles/images/Adm/GO.png"  height="12"> Bonus for level</span>
<div style="display: none; clear:both;" id="id_11">
	<table>
 <tr>
     <th><b>Level</b></th>
        <th><b>% per level</b></th>
        <th><b>% at a level</b></th>
    </tr>
    <tr>
     <td>1</td>
        <td>1%</td>
...
701 => array(0 => 'to armor', 1=> 'Armor spacecraft'),

  702 => array(0 => 'for shields'),

  703 => array(0 => 'construction time'),

  704 => array(0 => 'the extraction of resources'),

  705 => array(0 => 'to energy production'),

  706 => array(0 => 'research time'),

  707 => array(0 => 'flying time of ships'),
