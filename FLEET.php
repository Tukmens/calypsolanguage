...
$LNG['sys_mess_head']                 = 'Spy Report <span style=\'color:lime; font-weight:700;\'>%s [%d:%d:%d]</span> on %s';
...
$LNG['sys_colo_arrival']             = "The colonizers reached the coordinates";
...
$LNG['sys_expe_time_slow_6']         = 'The star wind of a red giant distorted the jump of the expedition so that the ships navigation system calculated the reentry incorrect. As a result the expedition return somewhere in the emptiness between the stars and the destination.';
...
$LNG['sys_perte_defenseur']           = 'Lost defender';
...
$LNG['sys_destruc_mess']              = 'The fleet from the planet [%d:%d:%d] flies to the moon [%d:%d:%d].';
...
$LNG['type_mission'][16]              = 'Expedition at the Hostal sector"';

$LNG['batl_log_mesage']				  = '<a href="CombatReport.php?raport=%s" target="_blank"><center><font color="%s">%s %s</font></a>
<br><br><font color="%s">%s: %s</font> <font color="%s">%s: %s</font>
...
<br></center>' ;
$LNG['batl_log_mesage_exp']			  = '<br>Received %s combat experience';
$LNG['batl_log_mesage_ally_points']	  = '<br>Received %s alliance development points.';
$LNG['batl_log_mesage_destroyed']	  = "<font color='red'>Your fleet was destroyed.<br> Contact with fleet is lost.</font>";
$LNG['host_mission_mesag']            = 'Hostal sector - ';

// мобы PvE
$LNG['fl_enemy'][1]                   = 'Barbarian';
$LNG['fl_enemy'][2]                   = 'Pirate';
$LNG['fl_enemy'][3]                   = 'Alien';

$LNG['fl_enemy_1'][1]                 = 'Barbarians';
$LNG['fl_enemy_1'][2]                 = 'Pirates';
$LNG['fl_enemy_1'][3]                 = 'Aliens';
// месаги ПвЕ
$LNG['fl_enemy_msg']['main']		  = 'Expedition came across %s enemy units at the hostal sector.';
$LNG['fl_enemy_msg']['tm']			  = 'Container with %s Dark matter was found.';
$LNG['fl_enemy_msg']['up']			  = 'Failed to upgrade %s in the %s pieces.';
$LNG['fl_enemy_msg']['pa']			  = 'Received %s academy points.';
$LNG['fl_enemy_msg']['exp']			  = 'You received %s experience points.';

//new mission
//поиск Звездной пыли
$LNG['sys_expe_found_stardust_1']     = 'Your fleet wandered off from the route and flew into unknown region of galaxy. What is this? Your fleet came across a rare star. From its wind we were able to get extremely rare artifact: 1 unit of Stardust.';
$LNG['sys_expe_found_stardust_2']     = 'Your expedition succeeded. They found a small dust particle after the explosion of a huge star. After closer examination scientists are sure that they have found 1 unit of the rare Stardust.';
$LNG['sys_expe_found_stardust_3']     = 'Your expedition got in the center of a strange star. The commander decided to send the fleet to search the module but instead they managed to find 1 unit of Stardust.';
$LNG['sys_expe_found_stardust_4']     = 'Your expedition found the destroyed ship of unknown origin. On board they found 1 unit of Stardust.';